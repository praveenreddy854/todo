...
app.post("/api/fn", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var response, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, llm_1.fnCallOpenAI)(req.body["message"])];
            case 2:
                response = _a.sent();
                res.json((0, responseHandler_1.getFilteredResponse)(response));
                return [3 /*break*/, 4];
            case 3:
                err_1 = _a.sent();
